...
# Dedicated registry prevents duplicate registration
...
# Normalize LF and write utf-8 (no BOM)
server = server.replace("\\r\\n", "\\n")
Path("bot/server.py").write_text(server, encoding="utf-8", newline="\\n")
print("OK: bot/server.py written")
